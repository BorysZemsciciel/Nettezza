...
class Attribute(object):
	...
	def set_numeric_range(self, lower_bound=-inf, upper_bound=inf):
		"""Set the numeric range for the attribute.

		Args:
			lower_bound (float): The smallest possible value for the attribute. (default -inf)
			upper_bound (float): The largest possible value for the attribute. (default inf)
		"""
